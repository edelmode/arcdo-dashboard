    ...
    return (
        <nav className="fixed bg-white top-0 flex items-center px-5 sm:px-10 z-50 ml-[250px] h-[4rem] w-screen">
            ...
            <ul className="hidden sm:flex sm:flex-row lg:mr-10 items-center space-x-10">
                <li>
                    <button className="text-md text-gray-600 hover:text-red-800 hover:transition duration-300">
                ...
                <span className="mr-2">{defaultPage}</span>
                {currentPage && (
                    <>
                        <span className="text-gray-500">/</span>
                        <span className="ml-2 font-bold">{currentPage}</span>
                    </>
                )}
            </div>
            </ul>
                ...
                <li className="flex items-center rounded-2xl border border-gray-300">
                    <div className="flex items-center">
                        ...
                        <input
                            type="text"
                            placeholder="Search..."
                            className="px-4 py-2 ml-2 rounded-2xl text-md text-gray-600 focus:outline-none focus:ring-2 focus:ring-red-800-400"
                        />
                    </div>
                </li>
                ...
                <li className="relative">
                    <button className="text-md text-gray-600 hover:text-red-800">
